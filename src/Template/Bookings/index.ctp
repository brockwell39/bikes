...
<div class="bookings index large-12 medium-9 columns content">
    <h3><?= __('Bookings') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('booking_end') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Cancel'), ['action' => 'cancel', $booking->id], ['confirm' => __('Are you sure you want to cancel your booking on {0}?', $booking->booking_start)]) ?>
